    ...
    return (
        ...
        <div className="container-fluid"> 
          ...
          <form className="form-inline my-2 my-lg-0" action="/restaurant/search" method="GET">
            <input className="form-control mr-sm-3" type="search" placeholder="Tìm kiếm" aria-label="Search" name="q" style={{width: '250px'}} />
          ...
          <div className="ml-auto">
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav mr-auto">
                ...
                <li className="nav-item active">
                  <a className="nav-link" href="/restaurant/listchat">Tin nhắn</a>
                </li>
              </ul>
              <li className="lneWsb"> 
